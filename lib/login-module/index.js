...
var init = function (app) {
    ...
    //mongoose.connect('mongodb://172.17.0.1:27017/csvApp');
    //mongoose.connect('mongodb://docker.for.win.localhost:27017/csvApp');
    mongoose.connect('mongodb://localhost:27017/csvApp');
    //mongoose.connect('mongodb://mongo/csvApp');
...
exports.User = User;
exports.checkUser = auth.checkUser;
