...
/**
 * @param {Object} data Represents data object from parsed file with all attributes needed for orion
 */
...
exports = module.exports = function del(data) {
    return new Promise(function (resolve, reject) {
        connection.v2.deleteEntity(data.id).then(
            (response) => {
